...
<!-- .replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;")
			...
			%>
			<a href="Nupdate.jsp?noticeID=<%=noticeID%>" class="btn btn-primary">수정</a>
			<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="NdeleteAction.jsp?noticeID=<%= noticeID %>" class="btn btn-primary">삭제</a>
			<%
				}
			%>
		</div>
